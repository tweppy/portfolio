...
const Experience = () => {
  return (
    <section className="text-white container pt-24 mx-auto lg:px-14 px-6 min-h-screen" id="experience">
        ...
        <div className="lg:w-4/6 bg-gray-800 p-4 rounded-lg">
          ...
          <ul className="gap-4 flex flex-col py-4">
            {history.map((historyItem, id) => {
              return (
                <li className="flex flex-row items-center gap-4 rounded-lg p-4 lg:p-2 bg-gray-900" key={id}>
                  <img className="w-20 lg:block hidden" src={getImageUrl(historyItem.imageSrc)} alt={`${historyItem.type} icon`} />
                  <div>
